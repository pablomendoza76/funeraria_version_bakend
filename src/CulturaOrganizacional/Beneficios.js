    ...
    <div className="beneficios">
      ...
      <main>
        <div className="contenido-principal">
          <h2>Beneficios para los Colaboradores</h2>
          <div className="cards-row">
            <div className="card">
              <img src="../img/beneficio1.jpg" alt="Beneficios Temporada Escolar" />
              <div className="card-content">
                <h3>Beneficios para Colaboradores Temporada Escolar</h3>
                <a href="/pdfs/BeneficiosTemporadaEscolar.pdf" target="_blank" rel="noopener noreferrer">
                  Visualizar y Descargar
                </a>
              </div>
            </div>
            <div className="card">
              <img src="../img/beneficio2.jpg" alt="Beneficios Farmacias y Academias" />
              <div className="card-content">
                <h3>Beneficios para Colaboradores Farmacias y Academias</h3>
                <a href="/pdfs/BeneficiosFarmaciasAcademias.pdf" target="_blank" rel="noopener noreferrer">
                  Visualizar y Descargar
                </a>
              </div>
            </div>
