        ...
        <div className="pagos-page">
            ...
            <main>
                ...
                <div className="content-container">
                    <h2>Sueldo y Pagos</h2>
                    <div className="cards-row">
                        <div className="card">
                            <img src="../img/ingreso_horas_extra.jpg" alt="PDF Preview" />
                            <div className="card-content">
                                <h3>Ingreso Horas Extra</h3>
                                <a href="/pdfs/IngresoHorasExtra.pdf" target="_blank" rel="noopener noreferrer">Visualizar y Descargar</a>
                            </div>
                        </div>
                    </div>
                </div>
